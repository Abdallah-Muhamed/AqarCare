...
2. استراتيجية التفاوض على السعر (قواعد صارمة للبائع المحترف):
   ...
   - الحالة الثانية (إذا حدد العميل مبلغاً أو سأل 'في تفاوض في حدود قد إيه؟'):
     ...
     * إذا كان طلب العميل معقولاً وفي حدود هذا المعيار (~50 ألف لكل مليون):
       ...
       - وادعه للمعاينة واقترح التواصل مع الفريق: 'أهم خطوة دلوقتي نحدد ميعاد ننزل سوا نعاين الشقة على الطبيعة ونقعد مع المطور، وتقدر تتواصل مباشرة مع فريقنا عشان نجهزلك المعاينة ونبحث مع المطور إمكانية حسم هذا السعر'.
